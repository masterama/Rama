...
echo
echo $red" Tool akan di install dalam waktu 5 detik saja"
echo $red" harap sabar menunggu Cokk :)"
sleep 1
echo '''\a
\033[32;1m              ____
\033[32;1m             |___ \
...
echo $i"Terima Kasih Anonymouse sudah mengunakan Tools ini"
sleep 2
...
echo $i"Melalui Via:"
sleep 2
echo $ku"Facebook :"$pur" Rama Dani"
echo $ku"YouTube  :"$pur" Rama Dani"
echo $ku"WhatsApp :"$pur" 081615788876"
sleep 2
echo $i"dan jangan lupa "$cy" LIKE SHARE AND SUBSCRIBE"
sleep 2
echo $i"Video Channel "$cy" Rama Dani"
sleep 2
